...
library SqrtPriceMathV2 {
    ...
    /// @return amount0 Amount of token0 required to cover a position of size liquidity between the two passed prices
    /// @return amount1 Amount of token1 corresponding to the passed liquidityDelta between the two prices
    function getAmountsForLiquidityV2(
        uint160 sqrtRatioX96,
        uint160 sqrtRatioAX96,
        uint160 sqrtRatioBX96,
        int128 liquidity
    ) public pure returns (int256 amount0, int256 amount1, bool isInRange) {
        if (sqrtRatioAX96 > sqrtRatioBX96) (sqrtRatioAX96, sqrtRatioBX96) = (sqrtRatioBX96, sqrtRatioAX96);
        ...
        if (sqrtRatioX96 <= sqrtRatioAX96) {
            ...
            amount0 = getAmount0Delta(sqrtRatioX96, sqrtRatioBX96, liquidity);
            amount1 = getAmount1Delta(sqrtRatioAX96, sqrtRatioX96, liquidity);
        } else {
